...
contract Berry  is Ownable, IResources {
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "Berry: transfer amount exceeds allowance"
            )
        );
        return true;
    }
    ...
    function decreaseAllowance(
        ...
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "Berry: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function excludeFromReward(address account) external onlyOwner {
        require(
            ...
            "Berry: account is already excluded"
        );
    ...
    function includeInReward(address account) external onlyOwner {
        require(
            _isExcludedFromRewards[account],
            "Berry: account is already included"
        );
    ...
    function setReflectionFeePercent(
        ...
        require(
            ...
            "Berry: you have reached fee limit"
        );
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
        require(
            ...
            "Berry: maxTxAmount should be greater than 1500000e9"
        );
    ...
    function reflectionFromToken(
        ...
        require(tAmount <= _tTotal, "Berry: amount must be less than supply");
    ...
    function tokenFromReflection(
        ...
        require(
            rAmount <= _rTotal,
            "Berry: amount must be less than total reflections"
        );
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "Berry: approve from the zero address");
        require(spender != address(0), "Berry: approve to the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(from != address(0), "Berry: transfer from the zero address");
        require(to != address(0), "Berry: transfer to the zero address");
        require(
            amount > 0,
            "Berry: transfer amount must be greater than zero"
        );
        require(
            amount <= balanceOf(from),
            "Berry: transfer amount exceeds balance"
        );
        if (from != owner() && to != owner()) {
            require(
                amount <= _maxTxAmount,
                "Berry: transfer amount exceeds the maxTxAmount."
            );
        }
