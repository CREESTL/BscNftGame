...
describe("Mining tests", async () => {
  ...
  describe("main functions", async () => {
    it("shuold revert startMining with Mining: this user already started mining process", async () => {
      ...
      await expect(
        mining
          .connect(owner)
          .startMining(1, acc1.address, [1, 0, 0], [1, 0, 0, 0, 0, 0])
      ).to.be.revertedWith("Mining: this user already started mining process");
    });
    ...
    it("shuold revert startMining with Pausable: paused", async () => {
      ...
      await expect(
        mining
          .connect(owner)
          .startMining(1, acc1.address, [1, 0, 0], [1, 0, 0, 0, 0, 0])
      ).to.be.revertedWith("User in blacklist");
    });
    ...
    it("shuold revert startMining with Mining: not enougth strength", async () => {
      ...
      await expect(
        mining
          .connect(owner)
          .startMining(1, acc1.address, [1, 0, 0], [1, 0, 0, 0, 0, 0])
      ).to.be.revertedWith("Mining: not enougth strength");
    });
    ...
    it("shuold revert endMining with Mining: user doesn't mine", async () => {
      ...
      await expect(mining.connect(acc2).endMining(1)).to.be.revertedWith(
    ...
    it("shuold revert endMining with Mining: too early", async () => {
      ...
      await expect(mining.connect(acc1).endMining(1)).to.be.revertedWith(
        "Mining: too early"
      );
    });
    ...
    it("shuold getRewards", async () => {
      ...
      await mining
        .connect(owner)
        .startMining(1, acc1.address, [0, 123, 0], [2, 1, 0, 0, 0, 0]);
